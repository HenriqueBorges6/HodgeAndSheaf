"""
Training script for Sheaf Neural Network on MUTAG dataset
"""
...
from models.sheaf_nn import SheafNeuralNetwork
...
def train_epoch(model, dataloader, optimizer, criterion, device, num_edge_types):
    ...
    for batch in dataloader:
        ...
        for sample in batch:
            ...
            # Compute Hodge Laplacian L1 (needed for sheaf structure)
...
def main():
    # Hyperparameters
    stalk_dim = 2  # Dimension of stalks attached to each edge
    hidden_dims = [32,64]
    num_classes = 2
    ...
    # Model
    print(f"\n=== Initializing Sheaf Neural Network (sheaf_type={sheaf_type}) ===")
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        if test_acc > best_test_acc:
            ...
            best_epoch = epoch
            # Save best model
            torch.save(model.state_dict(), f'best_sheaf_nn_{sheaf_type}.pt')

    # Final evaluation
    print("\n=== Final Evaluation ===")
    model.load_state_dict(torch.load(f'best_sheaf_nn_{sheaf_type}.pt'))
