"""
Random search sobre o grid Texas — amostra N configs aleatórias.
...
Uso:
    python -m src.experiments.bisheaf_diffusion.Node_Classification.Texas.sweep_sample
    python -m src.experiments.bisheaf_diffusion.Node_Classification.Texas.sweep_sample --n-samples 500
    python -m src.experiments.bisheaf_diffusion.Node_Classification.Texas.sweep_sample --n-samples 200 --seed 42
    python -m src.experiments.bisheaf_diffusion.Node_Classification.Texas.sweep_sample --resume results/grid/sample_partial.json
    python -m src.experiments.bisheaf_diffusion.Node_Classification.Texas.sweep_sample --dry-run
"""
...
def main(
    ...
    if dry_run:
        ...
        print(f"\n{'='*60}")
        print(f"  DRY RUN — Texas Random Search")
        print(f"{'='*60}\n")
    ...
    print(f"\n{'='*60}")
    print(f"  BiSheafDiffusion — Texas Random Search")
    print(f"  Grid total      : {total_grid:,} configs")
    print(f"  Amostra         : {sample_size} configs  (seed={seed})")
    print(f"  Splits          : {n_splits}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Texas Random Search — BiSheafNodeClassifier")
