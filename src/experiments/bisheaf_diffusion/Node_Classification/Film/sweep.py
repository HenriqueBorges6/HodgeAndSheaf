"""
Grid search para Film.

Uso:
    python -m src.experiments.bisheaf_diffusion.Node_Classification.Film.sweep
    python -m src.experiments.bisheaf_diffusion.Node_Classification.Film.sweep --workers 6
    python -m src.experiments.bisheaf_diffusion.Node_Classification.Film.sweep --n-splits 1
    python -m src.experiments.bisheaf_diffusion.Node_Classification.Film.sweep --dry-run
    python -m src.experiments.bisheaf_diffusion.Node_Classification.Film.sweep --resume results/grid_partial.json
"""
...
from src.experiments.bisheaf_diffusion.Node_Classification.Film.config import BASE_CONFIG, GRID
