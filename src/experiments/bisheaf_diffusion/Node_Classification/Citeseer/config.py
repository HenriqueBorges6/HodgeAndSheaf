"""
Configuração base e grid de hiperparâmetros para Citeseer.

Citeseer é um dataset Planetoid com split fixo (não tem múltiplos splits):
  3 327 nós · 9 228 arestas (undirected) · 6 classes
  Train: 120 nós · Val: 500 nós · Test: 1 000 nós
...
GRID — produto cartesiano de model × train:
  Modelo:
    ...
    hidden_channels  : canais internos [64, 128]
