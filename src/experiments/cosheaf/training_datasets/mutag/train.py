"""
Grid search da CoSheafNetwork no MUTAG.
...
Uso:
    ...
    python -m src.experiments.cosheaf.training_datasets.mutag.train --out-dir runs/mutag_v2
"""
...
from src.experiments.cosheaf.training_datasets.mutag.config import (
...
def sweep(out_dir="runs/cosheaf_mutag", dry_run=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out-dir", type=str, default="runs/cosheaf_mutag",
